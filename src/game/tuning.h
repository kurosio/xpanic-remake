...
MACRO_TUNING_PARAM(ShotgunSpeed, shotgun_speed, 200, "Shotgun speed")
...
MACRO_TUNING_PARAM(PlayerHooking, player_hooking, 0, "Enable player vs player hooking")
...
MACRO_TUNING_PARAM(ExplosionStrength, explosion_strength, 3.0f, "Explosion strength (grenade for example)")
MACRO_TUNING_PARAM(HammerStrength, hammer_strength, 0.0f, "Hammer strength")
